    ...
    <script>
        function calculate_menu() {
            var array_menu = {
                "Miso Soup": 5.00,
                "Edamame": 4.00,
                "Salad of the Day": 12.00,
                "Brussel Sprouts": 7.00,
                "Regular Tofu": 5.00,
                "Spicy Tofu": 5.00,
                "Ikura Tofu": 8.00,
                "Syrup Tofu": 5.50,
                "Homemade Organic Natto": 7.00,
                "Japanese Premium Rice": 3.00,
                "Chirashi (+ Japanese Uni)": 36.00,
                "Maguro Don": 34.00,
                "Otto Ramen": 16.00,
                "Mushroom Mazemen": 18.00,
                "Duck Mazemen": 24.00,
                "Uni Mazemen": 24.00,
                "Spicy Ikura Mazemen": 22.00,
                "Karaage": 12.00,
                "Ketchup": 7.50,
                "Yuzu Mayo": 9.00,
                "Sesame Dressing": 8.50,
                "Otto Aragoshi Ponzu": 8.00,
                "Soya Sauce for Sashimi": 6.50,
...
<body>
    ...
    <div style="background-color: rgba(0, 0, 0, 0.910);">
        ...
        <form class="orderMenu" id="menu" method="post" action="order-history.php">
            <table id="order-table" align="center" border="0">
                <tr>
                    <td>
                    ...
                    <td>
                        <h2 class="menu-header">Homemade Tofu</h5>
